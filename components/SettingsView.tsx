...
const SettingsView: React.FC<SettingsViewProps> = ({ isOpen, onClose, setView, fontSize, updateFontSize }) => {
        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-grow p-4">
            <ul className="space-y-2">
              <li>
                <button 
                  onClick={() => handleNavigation({ name: 'home' })}
              ...
              <li>
                <button 
                  onClick={() => handleNavigation({ name: 'profile' })}
                  className="w-full flex items-center p-3 text-left rounded-md hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                >
